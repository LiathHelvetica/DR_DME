...
def main() -> None:
	...
	model_initializers = [
		...
		# I FORGOT 242 # model_last_layer_sequential_heads(lambda: models.vit_l_16(weights=models.ViT_L_16_Weights.IMAGENET1K_V1), device, 1, 242, 242, "vit_l_16"),
		# I FORGOT 512 # model_last_layer_sequential_heads(lambda: models.vit_l_16(weights=models.ViT_L_16_Weights.IMAGENET1K_SWAG_E2E_V1), device, 1, 512, 512, "vit_l_16"),
		####
