...
AUGMENTATION_OUT_PATH = f"{DATA_PATH}/aug_out_b4"
AUGMENTATION_PLAIN_OUT_PATH = f"{DATA_PATH}/aug_out_plain_b4"
...
LAST_EPISODE_DONE_FILE = f"{CHECKPOINT_PATH}/last_episode.txt"
LAST_EPOCH_DONE_FILE = f"{CHECKPOINT_PATH}/last_epoch.txt"
LAST_FOLD_DONE_FILE = f"{CHECKPOINT_PATH}/last_fold.txt"
