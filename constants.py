...
LAST_EPISODE_DONE_FILE = f"{CHECKPOINT_PATH}/last_episode_b3.txt"
LAST_EPOCH_DONE_FILE = f"{CHECKPOINT_PATH}/last_epoch_b3.txt"
LAST_FOLD_DONE_FILE = f"{CHECKPOINT_PATH}/last_fold_b3.txt"
